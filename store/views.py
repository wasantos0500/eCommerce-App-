...
def product_list(request):
    ...
    return render(
        request,
        "store/products/product_list.html",
        {
            "products": products
        }
    )
...
def create_product(request):
    ...
    return render(
        request,
        "store/products/product_form.html",
        {
            "form": form
        }
    )
...
def store_detail(request, pk):
    ...
    return render(
        request,
        "store/stores/store_detail.html",
        {
            "store": store,
        },
    )
...
def delete_store(request, pk):
    ...
    return render(
        request,
        "store/stores/store_confirm_delete.html",
        {
            "store": store,
        },
    )
...
def delete_product(request, pk):
    ...
    return render(
        request,
        "store/products/product_confirm_delete.html",
        {
            "product": product,
        },
    )
...
def public_product_detail(request, pk):
    ...
    return render(
        request,
        "store/buyer/product_detail.html",
        {
            "product": product,
            "reviews": reviews,
...
def order_confirmation(request, order_id):
    ...
    return render(
        request,
        "store/orders/order_confirmation.html",
        {
            "order": order,
            "items": items,
        }
...
def external_posts(request):
    """
    Display posts retrieved from the JSONPlaceholder API.

    Posts can optionally be filtered by user ID using
    a GET query-string parameter.
    """

    user_id = request.GET.get("user_id")

    # Validate the optional user ID before sending it
    # to the external API helper.
    if user_id:
        try:
            user_id = int(user_id)
        except ValueError:
    ...
    return render(
        request,
        "store/integrations/external_posts.html",
        context,
    )
